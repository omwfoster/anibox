...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_cont_2, 42, 44);
	lv_obj_set_size(ui->screen_cont_2, 270, 378);
	...
	lv_obj_set_pos(ui->screen_btn_1, 23, 22);
	lv_obj_set_size(ui->screen_btn_1, 71, 27);
	...
	lv_obj_set_pos(ui->screen_btn_2, 24, 61);
	lv_obj_set_size(ui->screen_btn_2, 69, 27);
	...
	//lv_obj_set_style_text_font(ui->screen_btn_2, &lv_font_arial_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_btn_3, 26, 101);
	lv_obj_set_size(ui->screen_btn_3, 68, 28);
	...
	//lv_obj_set_style_text_font(ui->screen_btn_3, &lv_font_arial_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_spinner_1, 60, 214);
	lv_obj_set_size(ui->screen_spinner_1, 125, 128);
	lv_obj_set_scrollbar_mode(ui->screen_spinner_1, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_style_bg_color(ui->screen_spinner_1, lv_color_hex(0xf0fdff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_arc_width(ui->screen_spinner_1, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_arc_color(ui->screen_spinner_1, lv_color_hex(0xcacdd1), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_led_set_color(ui->screen_led_2, lv_color_hex(0x000000));
	lv_obj_set_pos(ui->screen_led_2, 522, 334);
	...
	lv_obj_set_pos(ui->screen_led_1, 487, 377);
	...
	lv_obj_set_pos(ui->screen_btn_4, 646, 373);
	...
	lv_obj_set_style_bg_color(ui->screen_btn_4, lv_color_hex(0xf30a30), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_btn_4, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_btn_4, 28, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//lv_obj_set_style_text_font(ui->screen_btn_4, &lv_font_arial_16, LV_PART_MAIN|LV_STATE_DEFAULT);
